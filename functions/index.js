...
// Example HTTP function (2nd Gen)
exports.helloWorld = onRequest((req, res) => {
  res.send("Hello from Firebase!");
});

// Version 2 of helloWorld function with logging (2nd Gen)
...
exports.sendWeeklyCertificates = onSchedule(
  {
  ...
  async (event) => {
    ...
    for (const studentDoc of studentsSnap.docs) {
      ...
      try {
        ...
        logger.error(`Failed to send certificate to ${student.parentEmail}: ${err.message}`);
      }
    }
    return null;
  }
...
exports.sendWeeklyCertificatesWithComments = onSchedule(
  {
  ...
  async (event) => {
    ...
    for (const studentDoc of studentsSnap.docs) {
      ...
      try {
        ...
        logger.error(`Failed to send certificate with comments to ${student.parentEmail}: ${err.message}`);
      }
    }
    return null;
  }
...
exports.updateBehaviorStreaks = onSchedule(
  {
